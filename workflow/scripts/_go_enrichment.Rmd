...
output:
  html_document:
params:
  sourcefile: "~/../../Volumes/data/carlisle/v2.0/scripts/_carlisle_functions.R"
  output_dir: "~/../../Volumes/data/carlisle/v2.0/results/peaks/0.1/gopeaks/annotation/go_enrichment"
  peak_list: ""
  species: "hg38"
  geneset_id: "GOBP"
editor_options: 
...
# set up peak list
peak_list=as.list(strsplit(peak_list, '\\s+'))[[1]]
