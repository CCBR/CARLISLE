...
params:
  ...
  peak_list: "~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.05/seacr/peak_output/53_H3K4me3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.relaxed.peaks.bedxxx~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.05/seacr/peak_output/53_H3K4me3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.relaxed.peaks.bedxxx~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.1/gopeaks/peak_output/53_H4K20m3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.broad.peaks.bedxxx~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.1/gopeaks/peak_output/53_H4K20m3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.narrow.peaks.bedxxx~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.1/gopeaks/peak_output/53_H4K20m3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.broad.peaks.bedxxx~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.1/gopeaks/peak_output/53_H4K20m3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.narrow.peaks.bedxxx~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.05/seacr/peak_output/HN6_H3K4me3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.relaxed.peaks.bedxxx~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.05/seacr/peak_output/HN6_H3K4me3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.relaxed.peaks.bedxxx~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.1/gopeaks/peak_output/HN6_H4K20me3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.broad.peaks.bedxxx~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.1/gopeaks/peak_output/HN6_H4K20me3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.narrow.peaks.bedxxx~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.1/gopeaks/peak_output/HN6_H4K20me3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.broad.peaks.bedxxx~/../../Volumes/data/carlisle/v2.0.2/results/peaks/0.1/gopeaks/peak_output/HN6_H4K20me3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.narrow.peaks.bed"
  species: "hg38"
  geneset_id: "GOBP"
  dedup_status: "dedup"
editor_options: 
...
if(length(new.packages)) {
  print(new.packages)
  install.packages(new.packages, INSTALL_opts = '--no-lock',repos = "http://cran.us.r-project.org")
}
...
if (debug=="Y"){
  speciesID="hg19"
  functionFile="~/../../Volumes/Pipelines/CARLISLE_dev/workflow/scripts/_carlisle_functions.R"
...
for (rowid in rownames(peak_df)){
  ...
  peak_df[rowid,"threshold"]=strsplit(peak_df[rowid,"peak_bed"]
                                      ,"/")[[1]][total_string_length-3]
  peak_df[rowid,"peak_caller"]=strsplit(peak_df[rowid,"peak_bed"],
                                        "/")[[1]][total_string_length-2]
  peak_df[rowid,"sampleid"]=strsplit(strsplit(peak_df[rowid,"peak_bed"],
                                              "/")[[1]][total_string_length],"[.]")[[1]][1]
  peak_df[rowid,"peak_type"]=strsplit(strsplit(peak_df[rowid,"peak_bed"],
                                               "/")[[1]][total_string_length],"[.]")[[1]][3]
  peak_df[rowid,"dedup_status"]=strsplit(strsplit(peak_df[rowid,"peak_bed"],
...
for (rowid in rownames(peak_df[c(1:max_samples),])){
  ...
  print("--QC Step 1")
  tss_obj=plot_dist_to_tss(peaks = READ_PEAK_FILE(peak_file_in=peak_df[rowid,"peak_bed"]), 
                           genome = speciesID)
  print(tss_obj)
