...
output:
  html_document:
params:
  sourcefile: "~/../../Volumes/Pipelines-1/CARLISLE_dev/workflow/scripts/_go_enrichment_functions.R"
  output_dir: "~/../../Volumes/data/sevillas2/carlisle/v2.0/results/peaks/0.1/gopeaks/go_enrichment"
  peak_list: "~/../../Volumes/data/carlisle/v2.0/results/peaks/0.05/macs2/peak_output/HN6_H4K20me3_1_vs_nocontrol.dedup.broad.peaks.bed ~/../../Volumes/data/carlisle/v2.0/results/peaks/0.05/macs2/peak_output/HN6_H4K20me3_1_vs_nocontrol.dedup.narrow.peaks.bed"
  species: "hg38"
  geneset_id: "GOBP"
editor_options: 
...
# list packages
list.of.packages=c("latticeExtra","pdp")
...
if (debug=="Y"){
  speciesID="hg19"
  functionFile="~/../../Volumes/Pipelines/CARLISLE_dev/workflow/scripts/_go_enrichment_functions.R"
  ...
  # peak_list="gopeaks/peak_output/53_H3K4me3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.broad.peaks.bed gopeaks/peak_output/53_H3K4me3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.narrow.peaks.bed gopeaks/peak_output/53_H3K4me3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.broad.peaks.bed gopeaks/peak_output/53_H3K4me3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.narrow.peaks.bed"
  
  # peak_list="seacr/peak_output/HN6_H4K20me3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.non_stringent.peaks.bed seacr/peak_output/HN6_H4K20me3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.norm_relaxed.peaks.bed seacr/peak_output/HN6_H4K20me3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.norm_stringent.peaks.bed seacr/peak_output/HN6_H4K20me3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.non_relaxed.peaks.bed seacr/peak_output/HN6_H4K20me3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.non_stringent.peaks.bed seacr/peak_output/HN6_H4K20me3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.norm_relaxed.peaks.bed seacr/peak_output/HN6_H4K20me3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.norm_stringent.peaks.bed seacr/peak_output/HN6_H4K20me3_2_vs_HN6_IgG_rabbit_negative_control_1.dedup.non_relaxed.peaks.bed"
}

# set up peak list
peak_list=as.list(strsplit(gsub(“[\r\n]”, “ ”, peak_list), '\\s+'))
...
for (rowid in rownames(peak_df)){
  peak_df[rowid,"threshold"]=strsplit(peak_df[rowid,"peak_bed"],"/")[[1]][10]
  peak_df[rowid,"peak_caller"]=strsplit(peak_df[rowid,"peak_bed"],"/")[[1]][11]
  peak_df[rowid,"sampleid"]=strsplit(strsplit(peak_df[rowid,"peak_bed"],"/")[[1]][13],"[.]")[[1]][1]
  peak_df[rowid,"peak_type"]=strsplit(strsplit(peak_df[rowid,"peak_bed"],"/")[[1]][13],"[.]")[[1]][3]
  peak_df[rowid,"dedup_status"]=strsplit(strsplit(peak_df[rowid,"peak_bed"],"/")[[1]][13],"[.]")[[1]][2]
}
...
for (rowid in rownames(peak_df[c(1:max_samples),])){
  print(paste0("** ",peak_df[rowid,"sampleid"]," | ", 
               peak_df[rowid,"peak_caller"], " | ", 
               peak_df[rowid,"peak_type"]," **"))

  print("--QC Step 1")
  tss_obj=plot_dist_to_tss(peaks = READ_PEAK_FILE(peak_df[rowid,"peak_bed"]), genome = speciesID)
  print(tss_obj)
  ...
  peak_df[rowid,"locusdf_list"]=SET_LOCUST_LIST(locus_loc)
...
#### Method 2: Poly-Enrich
###### Sub-method A: Without linking distal enhancers
...
###### Sub-method B: Linking distal enhancers
