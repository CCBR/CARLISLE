...
params:
  ...
  peak_list: "~/../../Volumes/data/carlisle/v2.0/results/peaks/0.1/gopeaks/peak_output/53_H4K20m3_1_vs_HN6_IgG_rabbit_negative_control_1.dedup.broad.peaks.bed"
  species: "hg38"
  geneset_id: "GOBP"
  dedup_status: "dedup"
editor_options: 
...
---
--peak_list --species hg38 --geneset_id GOBP --dedup_status dedup
