...
output:
  html_document:
    ...
    # toc_float: true
params:
  rawcountsmatrix: "~/../../../Volumes/data/test_carl/results/peaks/contrasts/MOC1_siSmyd3_2m_25_HCHO_vs_MOC1_siNC_2m_25_HCHO__dedup__narrowPeak/MOC1_siSmyd3_2m_25_HCHO_vs_MOC1_siNC_2m_25_HCHO__dedup__narrowPeak_countsmatrix.txt"
  coldata: "~/../../../Volumes/data/test_carl/results/peaks/contrasts/MOC1_siSmyd3_2m_25_HCHO_vs_MOC1_siNC_2m_25_HCHO__dedup__narrowPeak/MOC1_siSmyd3_2m_25_HCHO_vs_MOC1_siNC_2m_25_HCHO__dedup__narrowPeak_sampleinfo.txt"
  dupstatus: "dedup" # dedup or no_dedup
  condition1: "MOC1_siSmyd3_2m_25_HCHO"
  condition2: "MOC1_siNC_2m_25_HCHO" # contrasts is condition1 vs condition2 ... pay attention to the order of conditions
  ...
  results: "~/../../../Volumes/data/test_carl/results/peaks/contrasts/MOC1_siSmyd3_2m_25_HCHO_vs_MOC1_siNC_2m_25_HCHO__dedup__narrowPeak/MOC1_siSmyd3_2m_25_HCHO_vs_MOC1_siNC_2m_25_HCHO__dedup__narrowPeak_AUCbased_diffresults.txt"
  spiked: "Y"
  rawcountsprescaled: "N"
  scalesfbymean: "Y"
  bbpaths: "~/../../../Volumes/data/test_carl/results/peaks/contrasts/bed_bedgraph_paths.tsv"
  elbowlimits: "~/../../../Volumes/data/test_carl/results/peaks/contrasts/MOC1_siSmyd3_2m_25_HCHO_vs_MOC1_siNC_2m_25_HCHO__dedup__narrowPeak/MOC1_siSmyd3_2m_25_HCHO_vs_MOC1_siNC_2m_25_HCHO__dedup__narrowPeak_AUCbased_diffanalysis_elbowlimits.yaml"
  species: "mm10"
editor_options: 
...
# list packages
list.of.packages=c("BiocManager","DESeq2","edgeR", "tidyverse","dplyr", "DT","reshape2","pander","plotly", "ggplot2", "ggfortify", "ggrepel", "ELBOW", "yaml", "EnhancedVolcano", "ChIPseeker","stringr","RColorBrewer","HTSFilter", "TxDb.Mmusculus.UCSC.mm10.knownGene", "org.Mm.eg.db", "TxDb.Hsapiens.UCSC.hg19.knownGene","org.Hs.eg.db")
...
if (mean(colSums(rawcounts))>10000000){
  lib_factor=1e6
