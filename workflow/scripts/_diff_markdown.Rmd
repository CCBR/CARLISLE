...
# list packages
list.of.packages=c("BiocManager","DESeq2","edgeR", "tidyverse","dplyr", "DT","reshape2","pander","plotly", "ggplot2", "ggfortify", "ggrepel", "ELBOW", "yaml", "EnhancedVolcano", "RUVSeq", "ChIPseeker", "TxDb.Mmusculus.UCSC.mm10.knownGene", "org.Mm.eg.db", "stringr","RColorBrewer","HTSFilter")
